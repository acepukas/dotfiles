...
-- Find and existing window showing the given absolute path
...
function M.run_selection()
  ...
  -- Status: running
  vim.api.nvim_echo(
    { { "[sql-runner] Running query...", "ModeMsg" } },
    false,
    {}
  )
  ...
  vim.api.nvim_echo(
    { { string.format("[sql-runner] Done in %d ms", ms), "ModeMsg" } },
    false,
    {}
  )
end
...
vim.keymap.set(
  ...
  "<leader>p",
  ":RunSQL<CR>",
  { silent = true, desc = "Run SQL Selection" }
)
